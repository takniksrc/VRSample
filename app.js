...
class App{
    ...
    setEnvironment(){
        ...
        const self = this;
        //  venice_sunset_1k  monks_forest_2k  living_room  field_sky apartment  factory
	...
	loadCollege(){
		...
		loader.load(
			// resource URL  //college   dainingroom
			'smallhouse.glb',
            ...
            //     // college = gltf.scene.children[i];
			// 	self.scene.add( gltf.scene.children[i] );
            //   }
